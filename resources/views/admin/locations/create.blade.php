<x-app-layout>
    <x-slot name="header">Add Location</x-slot>

    <div class="mt-2 max-w-lg">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200">
            <div class="px-6 py-4 border-b border-gray-100">
                <h2 class="font-semibold text-gray-700">New Location</h2>
            </div>
            <form method="POST" action="{{ route('locations.store') }}" class="px-6 py-6 space-y-4">
                @csrf
                <div>
                    <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Location Name <span class="text-red-500">*</span></label>
                    <input type="text" id="name" name="name" value="{{ old('name') }}" required placeholder="e.g. Mwananyamala"
                ...
                <div>
                    ...
                    <input type="text" id="district" name="district" value="{{ old('district') }}" required placeholder="e.g. Kinondoni"
                ...
                <div>
                    ...
                    <input type="text" id="region" name="region" value="{{ old('region') }}" required placeholder="e.g. Dar es Salaam"
